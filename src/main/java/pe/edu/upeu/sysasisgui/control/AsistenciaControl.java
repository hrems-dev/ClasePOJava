...
public class    AsistenciaControl {
    ...
    @FXML
    private Label cantP, cantJ,cantA;
    ...
    public void generarResumen(){
        ...
        for(Asistencia asis: asistencias){
            if(asis.getEstado().equals("Presente")){
                p++;
            }else if(asis.getEstado().equals("Ausente")){
                a++;
            }else{
                j++;
            }
    ...
    public void guardarAsistencia(){
        ...
        for(Estudiante estudiante: estudiantes){
            asistenciaService.save(new Asistencia(estudiante.getNombre(),estudiante.isEstado()?"Presente":"Ausente"));
        }
    }
    private void listarAsistenciaR(){
